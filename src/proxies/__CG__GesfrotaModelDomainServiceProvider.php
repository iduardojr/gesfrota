 ...
 */
class ServiceProvider extends \Gesfrota\Model\Domain\ServiceProvider implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'alias', 'nif', 'services', 'contact', 'phone', 'email', 'active', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServiceProvider $proxy) {
