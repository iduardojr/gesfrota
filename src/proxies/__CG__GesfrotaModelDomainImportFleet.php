 ...
 */
class ImportFleet extends \Gesfrota\Model\Domain\ImportFleet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'items', 'agency', 'description', 'fileName', 'fileSize', 'header', 'finished', 'createdAt', 'finishedAt', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImportFleet $proxy) {
