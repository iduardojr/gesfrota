 ...
 * @DiscriminatorMap({"Access" = "Sigmat\Model\Domain\LogAccess", "Application" = "Sigmat\Model\Domain\LogApplication"})
 */
abstract class Log extends Entity {
	...
	/**
	 * @OneToMany(targetEntity="Sigmat\Model\Domain\LogContext", mappedBy="log")
	 * @var ArrayCollection
	 */
	protected $context;
