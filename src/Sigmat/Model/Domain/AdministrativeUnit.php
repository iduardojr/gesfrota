...
class AdministrativeUnit extends Node implements Activable {
	...
	/**
	 * @OneToOne(targetEntity="Sigmat\Model\Domain\Agency")
	...
	/**
	 * @OneToMany(targetEntity="Sigmat\Model\Domain\AdministrativeUnit", mappedBy="parent", indexBy="id")
	 * @OrderBy({"name" = "ASC"})
	 * @var ArrayCollection
	 */
	protected $children;
	...
	/**
	 * @ManyToOne(targetEntity="Sigmat\Model\Domain\AdministrativeUnit", inversedBy="children", fetch="EAGER")
