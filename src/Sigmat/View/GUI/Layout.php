...
class Layout extends View {
	...
	protected function buildNavbar() {
		...
		$nav->addItem(new NavLink('Gestão de Estoques', new TgDropdown($drop, false, false)));
		...
		$drop->addItem(new DropdownLink('Gerenciar Fornecedores', new TgLink(new Action('Sigmat\\Controller\\ProductController'))));
		$drop->addItem(new DropdownLink('Gerenciar Orgãos Externos', new TgLink(new Action('Sigmat\\Controller\\ProductController'))));
		$drop->addItem(new DropdownDivider());
		
		$drop->addItem(new DropdownHeader('Movimentações de Estoque'));
		$drop->addItem(new DropdownLink('Gerenciar Lançamentos', new TgLink(new Action('Sigmat\\Controller\\StockroomController'))));
		$drop->addItem(new DropdownLink('Gerenciar Documentos de Lançamento', new TgLink(new Action('Sigmat\\Controller\\StockroomController'))));
		$drop->addItem(new DropdownDivider());
		
		$drop->addItem(new DropdownHeader('Banco de Especificações'));
		...
		$drop->addItem(new DropdownLink('Gerenciar Unidades de Medida', new TgLink(new Action('Sigmat\\Controller\\ProductUnitController'))));
		$drop->addItem(new DropdownDivider());
		...
		$drop->addItem(new DropdownLink('Auditoria', new TgLink(new Action('Sigmat\\Controller\\ProductController'))));
		
		$drop->addItem(new DropdownDivider());
		
		$drop->addItem(new DropdownHeader('Financeiro'));
		$drop->addItem(new DropdownLink('Gerenciar Naturezas de Despesa', new TgLink(new Action('Sigmat\\Controller\\ProductController'))));
